...
Specifically, if the SSH port is inside the range, the script will automatically move the it to port `65432` for not losing access to the server after installation.
