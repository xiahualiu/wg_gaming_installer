...
function installWireGuard() {
	...
	echo "iptables -t nat -A PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 443 -j DNAT --to-destination ${CLIENT_WG_IPV4}:443" | sudo tee -a "/etc/wireguard/add-fullcone-nat.sh"
	...
	echo "iptables -t nat -A PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 443 -j DNAT --to-destination ${CLIENT_WG_IPV4}:443" | sudo tee -a "/etc/wireguard/add-fullcone-nat.sh"
	...
	echo "ip6tables -t nat -A PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 443 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:443" | sudo tee -a "/etc/wireguard/add-fullcone-nat.sh"
	...
	echo "ip6tables -t nat -A PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 443 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:443" | sudo tee -a "/etc/wireguard/add-fullcone-nat.sh"
  ...
  # rm-fullcone-nat.sh
	...
	****
	sudo echo "iptables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31400 -j DNAT --to-destination ${CLIENT_WG_IPV4}:31400" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "iptables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31401 -j DNAT --to-destination ${CLIENT_WG_IPV4}:31401" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
    sudo echo "iptables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31402 -j DNAT --to-destination ${CLIENT_WG_IPV4}:31402" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "iptables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31403 -j DNAT --to-destination ${CLIENT_WG_IPV4}:31403" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "iptables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31404 -j DNAT --to-destination ${CLIENT_WG_IPV4}:31404" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	*****	
	...
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 443 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:443" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
    ****
    sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 31400 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31400" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 31401 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31401" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 31402 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31402" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 31403 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31403" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p udp --dport 31404 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31404" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
    ****
	...
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 443 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:443" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	****
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31400 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31400" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31401 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31401" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31402 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31402" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31403 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31403" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
	sudo echo "ip6tables -t nat -D PREROUTING -i ${SERVER_PUB_NIC} -p tcp --dport 31404 -j DNAT --to-destination [${CLIENT_WG_IPV6}]:31404" | sudo tee -a "/etc/wireguard/rm-fullcone-nat.sh"
